...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/sonicboom0075/PackagerMirror/master/Packager_OneDrive.ps1' -OutFile 'Packager_OneDrive.ps1'
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/sonicboom0075/PackagerMirror/master/Sys/Resources/PackagerVersion.txt' -OutFile 'PackagerVersion.txt'
...
copy-Item "$selectedfolder\GKYE01.ini" -Destination "C:\Users\$env:UserName\OneDrive\Documents\Dolphin Emulator\GameSettings"
copy-Item "$selectedfolder\KHPE01.ini" -Destination "C:\Users\$env:UserName\OneDrive\Documents\Dolphin Emulator\GameSettings"
